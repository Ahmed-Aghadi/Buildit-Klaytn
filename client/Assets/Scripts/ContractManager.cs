...
public class ContractManager : MonoBehaviour
{
    ...
    string mapContractAddress = "0xdF78D5A57DCFf31Ca18978b56760867010AEBC2E";
    ...
    private async Task Initialize()
    {
        ...
        string usdPriceFeedAddress = await marketplaceContract.Read<string>("i_witnetPriceRouter");
